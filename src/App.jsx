  ...
  <div className="content-box">
    ...
    <div className="two-column-grid">
      <div className="geo-panel badge-shirak">
        <h3>Տեղանքի ռելիեֆի առանձնահատկությունների ուսումնասիրություն</h3>
        <p className="scientific-text">
          Հեծանվային երթուղի ընտրելիս կարևոր է ուսումնասիրել տեղանքի ռելիեֆը։
          Լեռնային և բլրային ճանապարհները պահանջում են ավելի մեծ ֆիզիկական ջանք,
          իսկ հարթ տարածքները հարմար են երկար և հանգիստ երթևեկության համար։
          Ռելիեֆի իմացությունը օգնում է ճիշտ պլանավորել երթուղին և խուսափել
          դժվարություններից։
        </p>
      </div>

      <div className="geo-panel badge-gyumri">
        <h3>Եղանակային առանձնահատկությունները հեծանվային սպորտում</h3>
        <p className="scientific-text">
          Եղանակը մեծ ազդեցություն ունի հեծանիվ վարելու վրա։ Արևոտ և մեղմ եղանակը
          նպաստում է անվտանգ ու հաճելի երթևեկությանը, իսկ ուժեղ քամին, անձրևը
          կամ մառախուղը կարող են դժվարացնել ճանապարհը։ Այդ պատճառով անհրաժեշտ է
          նախապես հետևել եղանակի կանխատեսումներին։
        </p>
      </div>

      <div className="geo-panel badge-shirak">
        <h3>Երթուղու պլանավորում ըստ տեղանքի</h3>
        <p className="scientific-text">
          Հեծանվորդները պետք է ընտրեն երթուղի՝ հաշվի առնելով ճանապարհների վիճակը,
          բարձրությունները և շրջակա միջավայրը։ Ճիշտ պլանավորված երթուղին ապահովում է
          ավելի անվտանգ և արդյունավետ ճանապարհորդություն, ինչպես նաև օգնում է խնայել
          ուժերն ու ժամանակը։
        </p>
      </div>

      <div className="geo-panel badge-gyumri">
        <h3>Հեծանիվը և շրջակա միջավայրը</h3>
        <p className="scientific-text">
          Հեծանիվը շրջակա միջավայրի համար ամենաանվնաս տրանսպորտային միջոցներից մեկն է։
          Այն չի արտանետում վնասակար գազեր և չի աղտոտում օդը։ Հեծանվի օգտագործումը
          նպաստում է բնության պահպանմանը և քաղաքների օդի մաքրությանը։
        </p>
      </div>

      <div className="geo-panel badge-shirak" style={{ gridColumn: '1 / -1' }}>
        <h3>Մաքուր միջավայրում առողջ մարմին</h3>
        <p className="scientific-text">
          Մաքուր օդում հեծանիվ վարելը բարենպաստ ազդեցություն ունի մարդու առողջության վրա։
          Բնության գրկում անցկացրած ժամանակը օգնում է թարմանալ, բարձրացնել տրամադրությունը
          և ամրացնել օրգանիզմը։ Մաքուր միջավայրը և ֆիզիկական ակտիվությունը միասին
          նպաստում են առողջ ապրելակերպին։
        </p>
      </div>
    </div>
  </div>
